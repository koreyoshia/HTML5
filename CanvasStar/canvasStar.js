; !function (undefined) {
	...
	function Star(id, x, y, useCache) {
		...
		this.color = "rgba("+Math.floor(Math.random() * 255)+","+Math.floor(Math.random() * 255)+","+Math.floor(Math.random() * 255)+"," + this.alpha + ")";
		if (useCache) {
			this.cache();
		}
	}
	...
	Star.prototype = {
		...
		cache: function () {
			...
			this.cacheCtx.shadowColor = "rgba(" + r + "," + g + "," + b + "," + a + ")";
	...
	function Dot(id, x, y, useCache) {
		...
		this.color = "rgba(Math.floor(Math.random() * 255),Math.floor(Math.random() * 255),Math.floor(Math.random() * 255)," + this.alpha + ")";
		this.dotCtx.color = "rgba(Math.floor(Math.random() * 255),Math.floor(Math.random() * 255),Math.floor(Math.random() * 255)," + this.dotCtx.alpha + ")";
	...
	Dot.prototype = {
		...
		cache: function () {
            ...
            b = Math.floor(Math.random() * 255);
            a = Math.floor(Math.random() * 255);
			this.dotCtx.shadowColor = "rgba(" + r + "," + g + "," + b + "," + a + ")";
